...
function ClientTopbar() {
    ...
    const profileButtonClass = isDark
        ? "flex h-[50px] w-[250px] min-w-0 shrink-0 items-center gap-2 rounded-2xl border border-white/10 bg-[linear-gradient(180deg,rgba(10,33,27,0.98)_0%,rgba(13,40,32,0.98)_100%)] px-4 py-2.5 text-sm font-bold text-[#98efcc] shadow-[0_14px_30px_rgba(0,0,0,0.18)]"
        : "flex h-[50px] w-[250px] min-w-0 shrink-0 items-center gap-2 rounded-2xl border border-white/10 bg-white/95 px-4 py-2.5 text-sm font-bold text-[#0b5a43] shadow-[0_14px_30px_rgba(0,0,0,0.08)]";
    return (
        <>
            <header className="sticky top-0 z-50 border-b border-white/10 bg-[linear-gradient(135deg,rgba(7,62,47,0.96)_0%,rgba(10,87,65,0.96)_58%,rgba(15,117,88,0.96)_100%)] text-white shadow-[0_18px_48px_rgba(6,40,31,0.22)] backdrop-blur-xl">
                <div className="relative mx-auto max-w-[1560px] px-6 sm:px-8 lg:px-10">
                    <div className="flex min-h-[82px] items-center justify-between gap-6 py-3 xl:min-h-[88px] xl:py-4">
                        ...
                        <div className="hidden shrink-0 items-center self-center gap-6 pl-6 min-[1500px]:flex">
