...
function SectionTitle({ eyebrow, title, highlight, desc, light = false }) {
    return (
        ...
        >
            ...
            <h2
                className={`mt-5 text-[34px] font-black leading-tight sm:text-[42px] md:text-[56px] ${light ? "text-white" : "text-[#0b4d3b]"
                    }`}
            >
            ...
            <p
                className={`mx-auto mt-4 max-w-3xl text-[15px] leading-7 md:text-[16px] ${light ? "text-white/82" : "text-slate-600"
                    }`}
            >
                {desc}
            </p>
...
function HeroParticle({ className, delay = 0, duration = 7 }) {
    return (
        <motion.div
            className={className}
            animate={{ y: [0, -24, 0], opacity: [0.18, 0.7, 0.18] }}
            transition={{
                duration,
                repeat: Infinity,
                ease: "easeInOut",
...
function GlowButton({ children, onClick, icon, large = false }) {
    return (
        <motion.button
            whileHover={{ y: -3, scale: 1.012 }}
            whileTap={{ scale: 0.985 }}
            onClick={onClick}
            className={`group relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-2xl bg-gradient-to-r from-[#f2bf2f] via-[#f6ca47] to-[#ffd96b] font-bold text-[#0b4d3b] shadow-[0_18px_36px_rgba(0,0,0,0.22)] transition ${large ? "px-7 py-4" : "px-5 py-3.5 text-sm"
                }`}
        >
            <span className="pointer-events-none absolute inset-0 opacity-0 transition duration-500 group-hover:opacity-100">
                <span className="absolute -left-12 top-0 h-full w-20 rotate-[18deg] bg-white/40 blur-md transition duration-700 group-hover:left-[115%]" />
            </span>
...
function PackageCard({ item, onQuote, badge, featured = false, dark = false, index = 0 }) {
    ...
    return (
        ...
        >
            ...
            <div className="pointer-events-none absolute left-[-35%] top-0 h-full w-[28%] rotate-[18deg] bg-white/25 opacity-0 blur-xl transition duration-700 group-hover:left-[115%] group-hover:opacity-100" />
        ...
        <div className="min-h-screen overflow-x-hidden bg-[#f6f3ec] text-[#0b4d3b]">
                    ...
                    <div className="grid items-center gap-10 lg:grid-cols-[1.08fr_.92fr]">
                        ...
                        >
                            ...
                            <motion.h2
                                ...
                                className="mt-4 max-w-4xl text-[40px] font-black leading-[0.96] sm:text-[54px] md:text-[72px]"
                            >
                                Luxury Event
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="rounded-2xl bg-[#f2bf2f]/15 p-3">
                                                <Stars className="h-5 w-5 text-[#f2bf2f]" />
                                            </div>
                                            <div>
                    ...
                    <div className="grid gap-5 md:grid-cols-3">
                        {[
                            ...
                            <motion.div
                                ...
                                className={`group relative overflow-hidden rounded-[30px] border p-7 text-center transition ${index === 1
                            ...
                            >
                                ...
                                <div className="absolute left-[-35%] top-0 h-full w-[30%] rotate-[18deg] bg-white/20 opacity-0 blur-xl transition duration-700 group-hover:left-[115%] group-hover:opacity-100" />
            ...
            <section className="relative overflow-hidden bg-[linear-gradient(135deg,#082f25_0%,#0b4d3b_55%,#0f6b50_100%)] px-5 py-14 md:px-10 md:py-16 lg:px-20">
                ...
                <motion.div
                    ...
                    viewport={{ once: true, amount: 0.2 }}
                    variants={fadeUp}
                    className="relative z-10 mx-auto flex max-w-6xl flex-col items-start justify-between gap-6 rounded-[32px] border border-white/10 bg-white/10 p-7 shadow-[0_18px_50px_rgba(0,0,0,0.15)] backdrop-blur-xl md:flex-row md:items-center md:p-8"
                >
