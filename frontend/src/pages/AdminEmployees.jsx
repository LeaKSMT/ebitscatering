...
function AdminEmployees() {
    ...
    const confirmDeleteEmployee = () => {
        ...
        const updated = employees.filter((item) => item.id !== employeeToDelete.id);
                ...
                <section className="grid grid-cols-1 gap-6 xl:grid-cols-[0.85fr_1.15fr]">
                    ...
                    >
                        ...
                        <form onSubmit={handleAddEmployee} className="mt-5 space-y-4">
                            ...
                            <Field label="Role" name="role" value={form.role} onChange={handleChange} placeholder="Chef, Server, Coordinator, etc." required />
                            <Field label="Contact Number" name="contactNumber" value={form.contactNumber} onChange={handleChange} />
    ...
    return (
        ...
        >
            <motion.div
                ...
                className="w-full max-w-[430px] overflow-hidden rounded-[24px] border border-[#efe2a9] bg-white shadow-[0_28px_80px_rgba(0,0,0,0.28)]"
            >
                ...
                <div className="px-6 py-5">
                    <p className="text-sm leading-7 text-slate-600">
                        ...
                        <span className="font-extrabold text-[#0f4d3c]">
                    ...
                    <div className="mt-6 flex justify-end gap-3">
                        <motion.button
                            ...
                            type="button"
                            onClick={onCancel}
                            className="rounded-2xl border border-[#dce7e2] bg-white px-5 py-3 text-sm font-semibold text-[#0f4d3c] transition hover:bg-[#f8fbfa]"
                        >
                            Cancel
                        </motion.button>
                        ...
                        <motion.button
                            ...
                            type="button"
                            onClick={onConfirm}
                            className="inline-flex items-center gap-2 rounded-2xl bg-red-500 px-5 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-red-600"
                        >
                            <Trash2 size={16} />
                            Delete
                        </motion.button>
